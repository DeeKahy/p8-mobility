...
export default function SvgComponent({ pointList, visible, onClose, onDelete }: PointProps) {
    ...
    <Modal visible={visible}>
      <View style={{ flex: 1, backgroundColor: '#f5f5f5', padding: 16 }}>
        ...
        <View style={{ flexDirection: 'row', justifyContent: 'space-around', paddingVertical: 20, marginBottom: 30 }}>
          <TouchableOpacity onPress={onDelete}><Text style={{ fontSize: 16 }}>Reset</Text></TouchableOpacity>
